...
export default function Sidebar({ activeCategoryId }: SidebarProps) {
  ...
  return (
    <aside className="products-sidebar sticky top-0 z-[60] isolate h-[100dvh] max-h-[100dvh] w-full shrink-0 self-start overflow-y-auto border-r border-slate-200 bg-white text-slate-950 shadow-sm">
