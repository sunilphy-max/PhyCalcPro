...
export type BearingResultsViewId = "summary" | "charts" | "diagnose" | "report";
...
type Props = {
  tabs: Tab[];
  defaultTab?: BearingResultsViewId;
};

export default function BearingResultsViewTabs({ tabs, defaultTab = "summary" }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div
        ...
        role="tablist"
        aria-label="Bearing results views"
      >
        {tabs.map((tab) => {
...
export const BEARING_VIEW_ICONS = {
  summary: Table2,
  charts: BarChart3,
