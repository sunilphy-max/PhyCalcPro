...
export default function ModuleCatalogPanel({ profile, maturity, calculatorRoute }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-blue-200 bg-blue-50/80 p-5 dark:border-blue-900 dark:bg-blue-950/40">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-blue-900/90 dark:text-blue-100">
            Validation: <span className="font-semibold capitalize">{profile.validationStatus}</span>
            {maturity ? (
              <>
                {" "}
      ...
      {profile.checks.length > 0 ? (
        <div className="mt-4">
          <h3 className="text-sm font-semibold text-blue-950 dark:text-blue-50">Engineering checks</h3>
