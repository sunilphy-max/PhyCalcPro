/**
 * Hand-authored flagship datasheets (composition, narrative, standards).
 * Merged with category templates for full 202-grade coverage in materialDatasheets.ts.
 */

import type { CompositionEntry, MaterialDatasheet } from "@/data/materialDatasheetTypes";
...
export const materialDatasheetsHandAuthored: Record<string, MaterialDatasheet> = {
  // ===================== Structural steels =====================
  s235jr: {
    summary:
    ...
    advantages: [
      "Lowest-cost common structural grade in many EU markets",
      "Excellent weldability for general fabrication",
      "Widely stocked plate and sections",
    ],
    limitations: [
      "Lower yield than S275/S355 — heavier members for the same load",
      "Requires coating outdoors",
      "Not preferred for primary high-capacity beams when higher grades are available",
    ],
    physicalNotes: "Density 7850 kg/m³. Common as plate, sections, and hollow sections.",
  ...
  s275jr: {
    ...
    advantages: [
      "Common EU default between S235 and S355",
      "Good fabrication and welding characteristics",
      "Balanced capacity vs cost for general steelwork",
    ],
    limitations: [
      "Lower yield than S355 for primary members",
      "Needs coating for outdoor exposure",
      "JR impact grade suited to ambient service only",
    ],
    physicalNotes: "Density 7850 kg/m³. Plate, sections, HSS, and bars.",
  ...
  s355jr: {
    ...
    advantages: [
      "Higher yield than S235/S275 for lighter primary members",
      "Widely specified for European beams, columns, and platework",
      "Good strength-to-cost for structural steelwork",
    ],
    limitations: [
      "Machinability moderate vs mild steel",
      "Coating required for corrosion protection",
      "Impact class JR for ambient service — check colder climates",
    ],
    physicalNotes: "Density 7850 kg/m³. Primary structural plate and sections.",
  ...
  "astm-a36": {
    ...
    advantages: [
      "Ubiquitous US mild structural steel — easy to specify and buy",
      "Excellent weldability and fabrication characteristics",
      "Familiar default for plates, bars, and secondary members",
    ],
    limitations: [
      "Lower yield than A992/A572 for primary W-shapes",
      "Must be painted or galvanized outdoors",
      "Not the preferred grade for modern wide-flange building frames",
    ],
    physicalNotes: "Density 7850 kg/m³. Plate, bars, and shapes.",
  ...
  "astm-a992": {
    ...
    advantages: [
      "Highest strength-to-weight among common US W-shape grades",
      "Most common stock for wide-flange beams and columns",
      "Excellent weldability for building frames",
      "Controlled yield/tensile range aids AISC design reliability",
    ],
    limitations: [
      "Primarily a shapes grade — plate work often uses A36/A572",
      "Requires coating for exposed architecture",
      "Availability focused on W-shapes vs all product forms",
    ],
    physicalNotes: "Density 7850 kg/m³. Preferred for wide-flange beams and columns.",
  ...
  "42crmo4-4140": {
    ...
    advantages: [
      "Default high-strength shaft steel with excellent hardenability",
      "Strong fatigue performance when QT correctly",
      "Widely available globally as bar and forging stock",
    ],
    limitations: [
      "Not stainless — needs corrosion protection",
      "Weldability requires preheat / PWHT practices",
      "QT condition reduces machinability vs annealed",
    ],
    physicalNotes: "Density ~7850 kg/m³. Bars, forgings, tubes.",
  ...
  "ss-316": {
    ...
    advantages: [
      "Improved chloride pitting resistance vs 304 (Mo-bearing)",
      "Proven for food, pharma, and chemical equipment",
      "Good toughness and weldability for austenitic stainless",
    ],
    limitations: [
      "Higher cost than 304",
      "Limited for continuous seawater immersion vs duplex / higher alloys",
      "Work-hardens rapidly in machining",
    ],
    physicalNotes: "Density ~8000 kg/m³. Sheet, plate, tube, bar, fasteners.",
  ...
  "al-6061": {
    ...
    advantages: [
      "Versatile heat-treatable Al-Mg-Si alloy with balanced properties",
      "Excellent machinability in T6",
      "Widely stocked worldwide in plate, extrusion, and bar",
      "Good atmospheric corrosion resistance",
    ],
    limitations: [
      "Lower strength than 7075 for aerospace primary structure",
      "Weld HAZ softens heat-treated temper",
      "Marine service needs care vs dedicated marine alloys",
    ],
    physicalNotes: "Density ~2700 kg/m³. Plate, sheet, extrusions, bar, tube.",
...
export function getHandAuthoredDatasheet(id: string): MaterialDatasheet | undefined {
  return materialDatasheetsHandAuthored[id];
}
