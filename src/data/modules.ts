...
export const categories: EngineeringCategory[] = [
  ...
  // =========================================================
  {
    ...
    modules: [
      {
        id: "bearings",
        title: "Bearing System Designer",
        description: "Application system design: stations, duty, ISO 281/76 life, catalog size",
        route: "/products/bearings/designer",
        category: "bearings",
        icon: Gauge,
        featured: true,
        tags: ["suite", "designer", "selection"],
      ...
      },
      {
        id: "bearing-life",
        title: "Bearing life",
        description: "Opens System Designer Verify panel (ISO 281 L10 / Lnm)",
        route: "/products/bearings/life",
        category: "bearings",
        icon: Clock,
        tags: ["suite", "life", "ISO 281", "redirect"],
        subGroup: "Absorbed into designer",
      },
      {
        id: "bearing-loads",
        title: "Equivalent load",
        description: "Opens System Designer Duty panel",
        route: "/products/bearings/loads",
        category: "bearings",
        icon: Activity,
        tags: ["suite", "loads", "redirect"],
        subGroup: "Absorbed into designer",
      },
      {
        id: "bearing-speed",
        title: "Bearing speed",
        description: "Opens System Designer Verify panel",
      ...
      },
      {
        ...
        description: "Opens System Designer System panel",
