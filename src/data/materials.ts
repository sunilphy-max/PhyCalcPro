...
export type Material = {
  ...
  /** Electrical resistivity (Ω·m) when published */
  electricalResistivity?: number;
  /** Specific heat capacity (J/(kg·K)) when published */
  specificHeat?: number;
  /** Melting / solidus temperature (K) when published */
  meltingPoint?: number;
};
...
const materialsCore: Material[] = [
  ...
  { id: "ss-316", name: "1.4401 (316)", category: "stainless-steel", standard: "EN 10088-2", E: 193e9, density: 8000, poisson: 0.29, thermalExpansion: 16e-6, thermalConductivity: 15, electricalResistivity: 7.4e-7, specificHeat: 500, meltingPoint: 1648, weldElectrodeStrength: 520e6, weldAllowableShear: 0.6 * 520e6, ...rivetFromSteel(220e6, 530e6), yieldStress: 220e6, ultimateStrength: 530e6 },
  { id: "ss-316l", name: "1.4404 (316L)", category: "stainless-steel", standard: "EN 10088-2", E: 193e9, density: 8000, poisson: 0.29, thermalExpansion: 16e-6, thermalConductivity: 15, electricalResistivity: 7.4e-7, specificHeat: 500, meltingPoint: 1648, weldElectrodeStrength: 520e6, weldAllowableShear: 0.6 * 520e6, ...rivetFromSteel(200e6, 500e6), yieldStress: 200e6, ultimateStrength: 500e6 },
  ...
  { id: "al-6061", name: "AW-6061 T6", category: "aluminum", standard: "ASTM B209", E: 68.9e9, density: 2700, poisson: 0.33, thermalExpansion: 23.6e-6, thermalConductivity: 167, electricalResistivity: 4.0e-8, specificHeat: 896, meltingPoint: 855, weldElectrodeStrength: 275e6, weldAllowableShear: 0.6 * 275e6, ...rivetFromSteel(276e6, 310e6), yieldStress: 276e6, ultimateStrength: 310e6, enduranceLimit: 96e6 },
  ...
  { id: "cu-c11000", name: "C11000 ETP copper", category: "copper-alloy", standard: "ASTM B152", E: 117e9, density: 8940, poisson: 0.34, thermalExpansion: 17e-6, ...rivetFromSteel(69e6, 220e6), yieldStress: 69e6, ultimateStrength: 220e6, costBand: "high", corrosionClass: "good", machinabilityIndex: 20, thermalConductivity: 391, electricalResistivity: 1.72e-8, specificHeat: 385, meltingPoint: 1358 },
