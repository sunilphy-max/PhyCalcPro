...
const maturityById: Record<string, Omit<ModuleMaturity, "moduleId">> = {
  ...
  "plain-bearings": { numericalDepth: 3, validationQuality: 2, refactorRisk: "medium", maturityBand: "formula", notes: "Journal, thrust pad and tilting-pad screening." },
  ...
  shells: { numericalDepth: 3, validationQuality: 2, refactorRisk: "low", maturityBand: "formula", notes: "Thin cylindrical shell membrane + bending screening." },
