...
export const unitFactors: UnitTable = {
  ...
  inertia: { m4: 1, mm4: 1e-12, cm4: 1e-8, in4: 4.16231e-7 },
  forcePerLength: { "N/m": 1, "kN/m": 1000, "N/mm": 1000, "lbf/ft": 14.5939, "lbf/in": 175.127 },
  moment: {
    "N\u00b7m": 1,
    "kN\u00b7m": 1000,
    "N\u00b7mm": 0.001,
  ...
  power: { W: 1, mW: 0.001, kW: 1000, MW: 1e6, hp: 745.7 },
  torque: {
    "N\u00b7m": 1,
    "kN\u00b7m": 1000,
    "N\u00b7mm": 0.001,
  ...
  time: { s: 1, ms: 0.001, min: 60, hr: 3600, day: 86400, year: YEAR_SECONDS },
  lengthPerTime: {
    "m/s": 1,
