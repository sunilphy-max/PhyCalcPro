...
const MODULE_OVERRIDES: Record<string, Partial<ModuleDesignWorkflow>> = {
  ...
  "v-belts": {
    ...
    linkedWorkflowModuleIds: ["shafts", "bearings", "multi-pulley", "keys-splines", "safety-factor"],
  ...
  "brakes-clutches": {
    ...
    linkedWorkflowModuleIds: ["shafts", "flywheels", "safety-factor"],
  },
  plates: {
    maturity: "solver-backed",
  ...
  hydraulics: {
    ...
    linkedWorkflowModuleIds: ["pipes", "plain-bearings", "safety-factor"],
  },
  "heat-exchangers": {
    maturity: "solver-backed",
  ...
  "combined-loading": {
    ...
    linkedWorkflowModuleIds: ["shafts", "fatigue", "safety-factor"],
  ...
  impact: {
    ...
    linkedWorkflowModuleIds: ["combined-loading", "safety-factor"],
  },
  suspension: {
    maturity: "solver-backed",
