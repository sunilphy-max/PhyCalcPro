...
const EXACT_REFERENCE_LINKS: Record<string, ReferenceDocLink> = {
  ...
  "ISO 898-1 / ISO 724 threads": { href: "/documentation/modules/bolts" },
  "DIN EN ISO bolt series": { href: "/documentation/modules/bolts" },
  "ANSI B18 inch bolts": { href: "/documentation/modules/bolts" },
  "ASME B1.1 unified threads": { href: "/documentation/modules/bolts" },
...
const KEYWORD_REFERENCE_LINKS: Array<{ pattern: RegExp; link: ReferenceDocLink }> = [
  ...
  { pattern: /bolt|thread|VDI|AISC|fastener|ISO 898|DIN EN ISO|ANSI B18|ASME B1/i, link: { href: "/documentation/modules/bolts" } },
