...
export const moduleUnitProfiles: Record<string, ModuleUnitProfile> = {
  ...
  "heat-exchangers": {
    ...
    power: { dimension: "power", defaultUnit: "kW", units: ["kW", "W", "hp"], label: "Heat duty" },
  },
  hydraulics: {
    diameter: { dimension: "length", defaultUnit: "mm", units: ["mm", "m", "in"], label: "Diameter" },
  ...
  impact: {
    ...
    velocity: { dimension: "velocity", defaultUnit: "m/s", units: ["m/s", "ft/s", "km/h", "mm/s"], label: "Velocity change" },
    duration: { dimension: "time", defaultUnit: "s", units: ["s", "min", "hr"], label: "Impact duration" },
  ...
  cams: {
    ...
    velocity: { dimension: "velocity", defaultUnit: "m/s", units: ["m/s", "mm/s", "ft/s"], label: "Velocity" },
    speed: { dimension: "frequency", defaultUnit: "rpm", units: ["rpm", "Hz", "rad/s"], label: "Cam speed" },
  },
  flywheels: {
    mass: { dimension: "mass", defaultUnit: "kg", units: ["kg", "lb"], label: "Mass" },
    radius: { dimension: "length", defaultUnit: "m", units: ["m", "mm", "in"], label: "Radius" },
  ...
  "torsion-springs": {
    ...
    torque: { dimension: "torque", defaultUnit: "N\u00b7m", units: ["N\u00b7m", "kN\u00b7m", "lbf\u00b7ft"], label: "Applied torque" },
  ...
  "plain-bearings": {
    ...
    speed: { dimension: "frequency", defaultUnit: "rpm", units: ["rpm", "Hz", "rad/s"], label: "Journal speed" },
  ...
  "brakes-clutches": {
    ...
    torque: { dimension: "torque", defaultUnit: "N\u00b7m", units: ["N\u00b7m", "kN\u00b7m", "lbf\u00b7ft"], label: "Transmitted torque" },
    speed: { dimension: "frequency", defaultUnit: "rpm", units: ["rpm", "Hz", "rad/s"], label: "Slip speed" },
  },
  "keys-splines": {
